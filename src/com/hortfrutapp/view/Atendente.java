...
public class Atendente {
	...
	Scanner leiaNum = new Scanner (System.in);
			...
			public int menuRemover() {
				...
				System.out.println("|| ============================= ||");
				System.out.println("|| 3 - Remover todas as Frutas   ||");
				System.out.println("|| 4 - Remover todas as Verduras ||");
				System.out.println("|| ============================= ||");
			...
			public static void totalProdutos() {
				...
				System.out.println("||        " + totalFrutas + " são frutas. " + totalVerduras + " são verduras.        ||");
			}
